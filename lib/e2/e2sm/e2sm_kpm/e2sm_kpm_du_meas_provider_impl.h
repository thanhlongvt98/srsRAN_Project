...
private:
  ...
  metric_meas_getter_func_t get_ue_index;
  ...
  metric_meas_getter_func_t get_dl_brate;
  metric_meas_getter_func_t get_dl_nof_ok;
  metric_meas_getter_func_t get_dl_nof_nok;
  metric_meas_getter_func_t get_dl_bs;
  metric_meas_getter_func_t get_pusch_snr_db;
  metric_meas_getter_func_t get_pusch_rsrp_db;
  metric_meas_getter_func_t get_pucch_snr_db;
  metric_meas_getter_func_t get_ta_ns;
  metric_meas_getter_func_t get_pusch_ta_ns;
  metric_meas_getter_func_t get_pucch_ta_ns;
  metric_meas_getter_func_t get_srs_ta_ns;
  metric_meas_getter_func_t get_dl_mcs;
  metric_meas_getter_func_t get_ul_mcs;
  metric_meas_getter_func_t get_ul_brate;
  metric_meas_getter_func_t get_ul_nof_ok;
  metric_meas_getter_func_t get_ul_nof_nok;
  metric_meas_getter_func_t get_last_phr;
  metric_meas_getter_func_t get_max_pusch_distance;
  metric_meas_getter_func_t get_max_pdsch_distance;
  metric_meas_getter_func_t get_bsr;
  metric_meas_getter_func_t get_nof_pucch_f0f1_invalid_harqs;
  metric_meas_getter_func_t get_nof_pucch_f2f3f4_invalid_harqs;
  metric_meas_getter_func_t get_nof_pucch_f2f3f4_invalid_csis;
  metric_meas_getter_func_t get_nof_pusch_invalid_harqs;
  metric_meas_getter_func_t get_nof_pusch_invalid_csis;
  metric_meas_getter_func_t get_avg_ce_delay;
  metric_meas_getter_func_t get_max_ce_delay;
  metric_meas_getter_func_t get_avg_crc_delay;
  metric_meas_getter_func_t get_max_crc_delay;
  metric_meas_getter_func_t get_avg_pusch_harq_delay;
  metric_meas_getter_func_t get_max_pusch_harq_delay;
  metric_meas_getter_func_t get_avg_pucch_harq_delay;
  metric_meas_getter_func_t get_max_pucch_harq_delay;
  metric_meas_getter_func_t get_avg_sr_to_pusch_delay;
  metric_meas_getter_func_t get_max_sr_to_pusch_delay;
