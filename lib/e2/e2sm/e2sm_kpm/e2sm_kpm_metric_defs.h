...
const size_t NOF_ORAN_E2SM_KPM_METRICS = 50;
...
inline span<const e2sm_kpm_metric_t> get_e2sm_kpm_oran_metrics()
{
  ...
  // Implementation-specific UE scheduler metrics exposed for xApp subscriptions.
  {"UE.UE-INDEX", NRCellDU, SI, INTEGER, "-", NO_LABEL, UE_LEVEL},
  {"UE.PCI", NRCellDU, SI, INTEGER, "-", NO_LABEL, UE_LEVEL},
  {"UE.RNTI", NRCellDU, SI, INTEGER, "-", NO_LABEL, UE_LEVEL},
  {"UE.CQI", NRCellDU, DER, INTEGER, "-", NO_LABEL, E2_NODE_LEVEL | UE_LEVEL},
  {"UE.DL-RI", NRCellDU, DER, REAL, "-", NO_LABEL, E2_NODE_LEVEL | UE_LEVEL},
  {"UE.UL-RI", NRCellDU, DER, REAL, "-", NO_LABEL, E2_NODE_LEVEL | UE_LEVEL},
  {"UE.DL-MCS", NRCellDU, DER, INTEGER, "-", NO_LABEL, E2_NODE_LEVEL | UE_LEVEL},
  {"UE.DL-BRATE", NRCellDU, DER, REAL, "kbps", NO_LABEL, E2_NODE_LEVEL | UE_LEVEL},
  {"UE.DL-NOF-OK", NRCellDU, CC, INTEGER, "-", NO_LABEL, E2_NODE_LEVEL | UE_LEVEL},
  {"UE.DL-NOF-NOK", NRCellDU, CC, INTEGER, "-", NO_LABEL, E2_NODE_LEVEL | UE_LEVEL},
  {"UE.DL-BS", NRCellDU, SI, INTEGER, "bytes", NO_LABEL, E2_NODE_LEVEL | UE_LEVEL},
  {"UE.PUSCH-SNR", NRCellDU, DER, REAL, "dB", NO_LABEL, E2_NODE_LEVEL | UE_LEVEL},
  {"UE.PUSCH-RSRP", NRCellDU, DER, REAL, "dB", NO_LABEL, E2_NODE_LEVEL | UE_LEVEL},
  {"UE.PUCCH-SNR", NRCellDU, DER, REAL, "dB", NO_LABEL, E2_NODE_LEVEL | UE_LEVEL},
  {"UE.TA-NS", NRCellDU, DER, REAL, "ns", NO_LABEL, E2_NODE_LEVEL | UE_LEVEL},
  {"UE.PUSCH-TA-NS", NRCellDU, DER, REAL, "ns", NO_LABEL, E2_NODE_LEVEL | UE_LEVEL},
  {"UE.PUCCH-TA-NS", NRCellDU, DER, REAL, "ns", NO_LABEL, E2_NODE_LEVEL | UE_LEVEL},
  {"UE.SRS-TA-NS", NRCellDU, DER, REAL, "ns", NO_LABEL, E2_NODE_LEVEL | UE_LEVEL},
  {"UE.UL-MCS", NRCellDU, DER, INTEGER, "-", NO_LABEL, E2_NODE_LEVEL | UE_LEVEL},
  {"UE.UL-BRATE", NRCellDU, DER, REAL, "kbps", NO_LABEL, E2_NODE_LEVEL | UE_LEVEL},
  {"UE.UL-NOF-OK", NRCellDU, CC, INTEGER, "-", NO_LABEL, E2_NODE_LEVEL | UE_LEVEL},
  {"UE.UL-NOF-NOK", NRCellDU, CC, INTEGER, "-", NO_LABEL, E2_NODE_LEVEL | UE_LEVEL},
  {"UE.LAST-PHR", NRCellDU, SI, INTEGER, "dB", NO_LABEL, E2_NODE_LEVEL | UE_LEVEL},
  {"UE.MAX-PUSCH-DISTANCE", NRCellDU, DER, INTEGER, "ms", NO_LABEL, E2_NODE_LEVEL | UE_LEVEL},
  {"UE.MAX-PDSCH-DISTANCE", NRCellDU, DER, INTEGER, "ms", NO_LABEL, E2_NODE_LEVEL | UE_LEVEL},
  {"UE.BSR", NRCellDU, SI, INTEGER, "bytes", NO_LABEL, E2_NODE_LEVEL | UE_LEVEL},
  {"UE.NOF-PUCCH-F0F1-INVALID-HARQS", NRCellDU, CC, INTEGER, "-", NO_LABEL, E2_NODE_LEVEL | UE_LEVEL},
  {"UE.NOF-PUCCH-F2F3F4-INVALID-HARQS", NRCellDU, CC, INTEGER, "-", NO_LABEL, E2_NODE_LEVEL | UE_LEVEL},
  {"UE.NOF-PUCCH-F2F3F4-INVALID-CSIS", NRCellDU, CC, INTEGER, "-", NO_LABEL, E2_NODE_LEVEL | UE_LEVEL},
  {"UE.NOF-PUSCH-INVALID-HARQS", NRCellDU, CC, INTEGER, "-", NO_LABEL, E2_NODE_LEVEL | UE_LEVEL},
  {"UE.NOF-PUSCH-INVALID-CSIS", NRCellDU, CC, INTEGER, "-", NO_LABEL, E2_NODE_LEVEL | UE_LEVEL},
  {"UE.AVG-CE-DELAY", NRCellDU, DER, REAL, "ms", NO_LABEL, E2_NODE_LEVEL | UE_LEVEL},
  {"UE.MAX-CE-DELAY", NRCellDU, DER, REAL, "ms", NO_LABEL, E2_NODE_LEVEL | UE_LEVEL},
  {"UE.AVG-CRC-DELAY", NRCellDU, DER, REAL, "ms", NO_LABEL, E2_NODE_LEVEL | UE_LEVEL},
  {"UE.MAX-CRC-DELAY", NRCellDU, DER, REAL, "ms", NO_LABEL, E2_NODE_LEVEL | UE_LEVEL},
  {"UE.AVG-PUSCH-HARQ-DELAY", NRCellDU, DER, REAL, "ms", NO_LABEL, E2_NODE_LEVEL | UE_LEVEL},
  {"UE.MAX-PUSCH-HARQ-DELAY", NRCellDU, DER, REAL, "ms", NO_LABEL, E2_NODE_LEVEL | UE_LEVEL},
  {"UE.AVG-PUCCH-HARQ-DELAY", NRCellDU, DER, REAL, "ms", NO_LABEL, E2_NODE_LEVEL | UE_LEVEL},
  {"UE.MAX-PUCCH-HARQ-DELAY", NRCellDU, DER, REAL, "ms", NO_LABEL, E2_NODE_LEVEL | UE_LEVEL},
  {"UE.AVG-SR-TO-PUSCH-DELAY", NRCellDU, DER, REAL, "ms", NO_LABEL, E2_NODE_LEVEL | UE_LEVEL},
  {"UE.MAX-SR-TO-PUSCH-DELAY", NRCellDU, DER, REAL, "ms", NO_LABEL, E2_NODE_LEVEL | UE_LEVEL}}};
  // clang-format on
  return metrics;
}
